...
//     unit: "°C",
//     stops: [
//       { value: -30, color: "#1e3a8a" }, // Dark Blue
//       { value: -10, color: "#3b82f6" }, // Blue
//       { value: 0, color: "#60a5fa" },   // Light Blue
//       { value: 10, color: "#4ade80" },  // Green
//       { value: 20, color: "#facc15" },  // Yellow
//       { value: 30, color: "#f97316" },  // Orange
//       { value: 40, color: "#ef4444" },  // Red
//     ],
//   },
//   precip: {
//     title: "Niederschlag",
...
//     unit: "mb",
//     stops: [
//       { value: 950, color: "#7e22ce" },
//       { value: 1000, color: "#3b82f6" },
//       { value: 1013, color: "#10b981" },
//       { value: 1030, color: "#f59e0b" },
//       { value: 1050, color: "#b91c1c" },
//     ],
//   },
//   wind: {
//     title: "Windgeschwingdiigkeit",
//     unit: "km/h",
//     stops: [
//       { value: 0, color: "#f8fafc" },
//       { value: 20, color: "#cbd5e1" },
//       { value: 40, color: "#94a3b8" },
//       { value: 60, color: "#64748b" },
//       { value: 100, color: "#1e293b" },
//       { value: 150, color: "#020617" },
//     ],
//   },
// };